...
export function SearchInput() {
  ...
  // calling the search input server function :-
  ...
  return (
    <div className="relative w-full max-w-sm z-10">
      ...
      {open && term.length >= 2 && (
        <div className="absolute top-full mt-2 border bg-popover text-popover-foreground shadow-md animate-in fade-in-0 outline-none zoom-in-95">
          {results === undefined ? (
